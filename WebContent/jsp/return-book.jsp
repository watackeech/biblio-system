				...
				<form class="row">
					<div class="col-md-12 mb-3">
						<div class="form-floating">
							<input type="text" class="form-control w-100" id="barcode-id"
								name="barcodeId" placeholder="書籍名を入力してください"> <label
								for="barcode-id">書籍のバーコード番号</label>
						</div>
					</div>
					<div class="col-md-12 d-flex justify-content-center">
						<button type="submit" id="return-button"
							class="btn btn-outline-primary" formaction="return-book"
